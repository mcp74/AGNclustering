...
from AGNclustering.error import _vor_block, _BASS_block, _AO13_block, _S82X_block, _XXL_block, _Comb_block
from Corrfunc.mocks import DDrppi_mocks
from Corrfunc.mocks import DDsmu_mocks

def wppi_auto_jackknife(d,r,m,pimax,pibins,rpbins,estimator,covariance=True,survey=None):
...
def wppi_cross_jackknife(d1,d2,r1,r2,m,pimax,pibins,rpbins,estimator,covariance=True,survey=None,weights1=None,weights2=None):
	#print('beginning jackknifes')
	if survey=='BASS':
	...
	for i in np.arange(M):
		...
		wp_t = wppi_d1d2(d1=d1set, d2=d2set, r1=r1set, r2=r2set, pibins=pibins, rpbins=rpbins, pimax=pimax, estimator=estimator)
		wp_arr=np.vstack((wp_arr,wp_t))
	wp_arr=wp_arr[1:]
